...
```
*Маша.* Теперь клиент может сам сконфигурировать армию Эльфов, упрощая ее создание:
```c#
...
```
*Саша*. Ладно, технически я понял, кто это реализовать. Но говорят, Барри на собеседовании может спросить про идеологичские различия. Так когда Прототип, а когда Фабрику? Или может Прототип вместо Фабрики?
...
*Саша.* Технически я смогу ответить Барри, как реализованы Фабрики. А про идеологию...
